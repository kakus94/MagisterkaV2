 ...
 *      Author: Marcin Przepiórkowski	(based from http://vidieukhien.xyz)
 *  	e-mail: przepiorkowski.marcin@gmail.com
 */
...
typedef struct {
	...
	SPI_HandleTypeDef SPI_RFID;

}RFID_type_def;

RFID_type_def* SPI_use_instance;
 ...
 * MFRC522 Commands
 */
#define PCD_IDLE												0x00	// NO action; Cancel current CMD
